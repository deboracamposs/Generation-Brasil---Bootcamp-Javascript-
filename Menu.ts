    ...
    while (true) {
        ...
        switch (opcao) {
            case 1:
                ...
                switch (tipo) {
                    case 1:
                        console.log("\nDigite o Limite de Crédito da Conta (R$): ");
            ...
            case 4:
                ...
                if (conta != null){
                    ...
                    switch (tipo) {
                        case 1:
                            console.log("Limite de Crédito da Conta (R$): ");
                            limite = readlinesync.questionFloat("");
                            contas.atualizar(
            ...
            case 8:
                ...
                console.log("Digite o valor da Conta de Destino: ");
...
function sobre(): void {
    ...
    console.log("https://github.com/deboracamposs");
    console.log("=====================================================");
}
